                ...
                <div v-if="projects.length" class="grid md:grid-cols-2 gap-8">
                    <Link v-for="project in projects" :key="project.id" :href="route('project.show', project.id)" class="group cursor-pointer">
                        <div class="aspect-video mb-6 overflow-hidden rounded-2xl bg-gray-100 dark:bg-zinc-900 border border-[#e5e5e5] dark:border-[#1a1a1a]">
                            <img v-if="project.images && project.images.length" :src="project.images[0]" :alt="project.title" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
        ...
        <section id="contact" class="py-32 px-6">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-6">
                    <a href="mailto:stevanushiaa@gmail.com" class="text-2xl font-bold border-b-2 border-black dark:border-white hover:text-gray-500 transition-colors">stevanushiaa@gmail.com</a>
